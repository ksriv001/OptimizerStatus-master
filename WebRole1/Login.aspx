    ...
    <section id =" imageform">
      ...
      <%--  <asp:Login ID="Login1" runat="server" ViewStateMode="Disabled" RenderOuterTable="false">--%>
       ...
       <%-- </asp:Login>--%>
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl="https://tracker.flightview.com/FVDelay/DelayMap.asp?custId=FVPublicSite&mapId=NAEntire670x390" Height="281px" ImageAlign="Middle" Width="428px" style="margin-left: 0px; margin-right: 0px" /><br /><br /><br /><br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</section>
